...
<body>
    ...
    <form action="${pageContext.request.contextPath}/PaymentServlet?action=insert" method="post" class="form-container" enctype="multipart/form-data">
        <h2>Payment</h2>
        ...
        <div class="form-group">
            ...
            <label for="recite" class="custom-file-upload">
                <input type="file" id="recite" name="recite" class="form-control-file" required>
                Choose File
            </label>
        </div>
