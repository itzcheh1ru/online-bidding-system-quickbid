...
<!-- Insert Product URL -->
    <c:url value="insertfeedback.jsp" var="adminsert">
    ...
    <a href="${adminsert}">
        <input type="button" name="insertfeedback" value="Insert Feedback" class="btn btn-primary">
    </a>
    ...
    <a href="${admupdate}">
        <input type="button" name="updatefeedback" value="Update Feedback" class="btn btn-primary">
    </a>

    <br><br>

    <!-- Delete Product URL -->
    <c:url value="deletefeedback.jsp" var="admdelete">
         <c:param name="id" value="${id}" />
        <c:param name="feedbackdescription" value="${pdescription}" />
        <c:param name="sellerid" value="${psellerid}" />
        <c:param name="bidderid" value="${pbidderid}" />
    ...
    <a href="${admdelete}">
        <input type="button" name="deletefeedback" value="Delete Feedback" class="btn btn-danger">
    </a>
</div>
