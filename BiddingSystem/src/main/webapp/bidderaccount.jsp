    ...
    <tr>
      <td>
        <form action="bid" method="post">
          <input type="submit" name="submit" value="Place  Update And Delete Bid" class="btn btn-primary btn-lg"><br><br>
        </form>
      </td>
    </tr>
    <tr>
      <td>
        <form action="bidder" method="post">
          <input type="submit" name="submit" value="Create Update And Delete Bidder Account" class="btn btn-primary btn-lg"><br><br>
        </form>
      </td>
    </tr>
    <tr>
      <td>
        <form action="feedback" method="post">
          <input type="submit" name="submit" value="Add Update And Delete Feedback Details" class="btn btn-primary btn-lg"><br><br>
        </form>
      </td>
    </tr>
  </table>
