...
%>
<form action="delete50" method="post">
<table class="table table-bordered table-striped text-center">
	<tr>
		<th>Enter Feedback number(Feedback ID)</th>
		<td><input type="text" name="id" value="<%= id%>" ><br></td>
		<td> <input type="submit" name="submit" value="delete feedback" class="btn btn-success"> <br></td>
	</tr>
</table>
