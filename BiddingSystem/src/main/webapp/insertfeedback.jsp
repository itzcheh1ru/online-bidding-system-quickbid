...
<form action="insert2" method="post" class="form-container">
    <h4>Add Feedback</h4>

    <div class="form-group">
        <label for="id" class="c">Feedback ID</label>
        <input type="text" name="pid" placeholder="Enter Feedback ID" required>
    </div>
    <div class="form-group">
        <label for="name" class="c">Feedback Description</label>
    ...
    <div class="form-group">
        <label for="bid" class="c">Bidder ID</label>
        <input type="text" name="bid" placeholder="Enter Bidder ID">
    </div>

    <button type="submit" class="btn-primary">Insert Feedback</button>
</form><br>
