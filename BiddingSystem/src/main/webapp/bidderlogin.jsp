...
<head>
    <meta charset="UTF-8">
    <title>Bidder Login - Quick Bid.Lk</title>
...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card"><br> 
                <form action="login1" method="post" class="box">
                    <h1>Login</h1>
                    <p class="text-muted">
                        <font color="#7A7A7A">Please Enter Bidder Username and Password</font>
                    </p>
                    <input type="text" name="busername" placeholder="Enter your Username" required>
                    <input type="password" name="bpassword" placeholder="Enter your Password" required>
                    <input type="submit" name="submit" value="Login">

                    <!-- Signup Button -->
                    <div class="mt-3">
                        <input type="button" onclick="location.href='bidderinsertupdate.jsp';" value="Sign Up" class="login-btn">
                    </div>
