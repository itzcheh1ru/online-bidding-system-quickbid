...
<head>
    ...
    <script>
        function validateForm() {
            ...
            var telephone = document.forms["adminForm"]["AdminTelephone"].value;
            var nic = document.forms["adminForm"]["AdminNIC"].value;
            var username = document.forms["adminForm"]["Ausername"].value;
            var password = document.forms["adminForm"]["Apassword"].value;
            
            
            if (name == "" || telephone == "" || nic == "" || username == "" || password == "") {
            ...
            if (nic.length != 10 && nic.length != 12) {
                alert("Please enter a valid NIC number (10 or 12 characters)");
                return false;
            }
...
<body>
    ...
    <form name="adminForm" action="insert" method="post" class="box" onsubmit="return validateForm()">
        ...
        <div class="form-group">
            ...
            <input type="text" name="AdminTelephone" placeholder="Enter your telephone number" required>
        </div>
        <div class="form-group">
            <label for="NIC">NIC</label>
            <input type="text" name="AdminNIC" placeholder="Enter your NIC number" required>
        </div>
        <div class="form-group">
        ...
        <input type="submit" name="submit" value="Insert Admin">
    </form>

    <form action="view" method="post" class="box">
        <input type="submit" name="submit" value="View admin details and update">
    </form>
