...
<div>
  <table class="center">
    ...
    <tr>
      <td>
        <a href="admininsertupdate.jsp"><button class="btn btn-primary btn-lg">View Admin Details</button></a><br><br>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <form action="item" method="post">
          <input type="submit" name="submit" value="View Item Details" class="btn btn-primary btn-lg"><br><br>
        </form>
      </td>
    </tr>
    <tr>
      <td>
        <a href="Bidlist.jsp"><button class="btn btn-primary btn-lg">View Bid Details</button></a><br><br>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <a href="insert.jsp"><button class="btn btn-primary btn-lg">View Employee Details</button></a><br><br>
      </td>
    </tr>
  </table>
</div>
