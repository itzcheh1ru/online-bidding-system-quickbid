...
<head>
<meta charset="UTF-8">
<title>Update Bidder details</title>
...
<%
	...
	String telephone = request.getParameter("btelephone");
...
<tr>
	<th>Bidder Name</th>
	<td><input type="text" class="form-control" name="bname" value="<%= name %>"><br></td>
</tr>
<tr>
	<th>Bidder Telephone</th>
	<td><input type="text" class="form-control" name="btelephone" value="<%= telephone %>"><br></td>
</tr>
<tr>
	<th>Bidder NIC</th>
	<td><input type="text" class="form-control" name="bNIC" value="<%= NIC %>"><br></td>
</tr>
<tr>
	<th>Bidder Username</th>
	<td><input type="text" class="form-control" name="busername" value="<%= username %>"><br></td>
</tr>
<tr>
	<th>Bidder Password</th>
	<td><input type="text" class="form-control" name="bpassword" value="<%= password %>"><br></td>
</tr>
</table>
